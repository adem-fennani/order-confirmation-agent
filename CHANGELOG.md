...
### Added
- **GitHub Release Automation**: Added a new feature to automate the GitHub release process.
- **Admin Panel**: A new admin panel to manage orders and users.
- **SQLite Command**: Added a new command to delete orders by client name.
