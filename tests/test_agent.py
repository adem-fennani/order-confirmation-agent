...
def test_remove_item_english(agent, db):
    order = Order(
        id="test_remove_en",
        customer_name="Alice",
...
def test_remove_item_french(agent, db):
    order = Order(
        id="test_remove_fr",
        customer_name="Alice",
        customer_phone="1111111111",
...
def test_add_item_english(agent, db):
    order = Order(
        id="test_add_en",
        customer_name="Bob",
...
def test_add_item_french(agent, db):
    order = Order(
        id="test_add_fr",
        customer_name="Bob",
        customer_phone="2222222222",
...
def test_replace_item_english(agent, db):
    order = Order(
        id="test_replace_en",
        customer_name="Carol",
...
def test_replace_item_french(agent, db):
    order = Order(
        id="test_replace_fr",
        customer_name="Carol",
        customer_phone="3333333333",
...
def test_modify_quantity_english(agent, db):
    order = Order(
...
def test_modify_quantity_french(agent, db):
    order = Order(
...
def test_cancel_order_english(agent, db):
    order = Order(
        id="test_cancel_en",
        customer_name="Eve",
...
def test_cancel_order_french(agent, db):
    order = Order(
        id="test_cancel_fr",
        customer_name="Eve",
        customer_phone="5555555555",
...
def test_ambiguous_request_english(agent, db):
    order = Order(
        id="test_ambig_en",
        customer_name="Frank",
...
def test_ambiguous_request_french(agent, db):
    order = Order(
        id="test_ambig_fr",
        customer_name="Frank",
        customer_phone="6666666666",
...
def test_language_switch_mid_conversation(agent, db):
    order = Order(
        id="test_langswitch",
        customer_name="Grace",
